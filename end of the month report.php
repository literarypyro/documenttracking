...
?>
	...
	<select class='form-control' name='filterDocument'>
	...
	<select class='form-control' name='filterMonth'>
	<?php
	for($i=1;$i<13;$i++){
	...
	if(($nm>0)||(($nm==0)&&(($_SESSION['filterDocument']=="SENT")||($_SESSION['filterDocument']=="ALL")))){
		?>
	<table id='cssTable' class='table table-striped table-hover' width=100% >
	<thead>
	<tr>
	...
	<div class='form-group'>	
	<select  class='form-control' name='sentMonth'>
	<?php
	for($i=1;$i<13;$i++){
	...
	<div class='form-group'>	
	<select  class='form-control' name='sentYear'>
	<?php
	for($i=6;$i<25;$i++){
		$yy=2000+$i*1;
	?>
	...
	<div class='form-group'>
	<select  class='form-control' name='awaitMonth'>
	<?php
	for($i=1;$i<13;$i++){
	...
	<div class='form-group'>
	<select  class='form-control' name='awaitYear'>
	<?php
	for($i=6;$i<25;$i++){
		$yy=2000+$i*1;
	?>
	...
	?>
	<div align=center><input class='btn btn-info' type=button value='Prepare Print Out' onclick='openPrint("print_outline.php")' /></div>
	<br>
	</body>
