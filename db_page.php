...
//	$db=new mysqli('sup-psilva','records_officer','123456','records');
	$db=new mysqli ( 'mysqlsdb.co8hm2var4k9.eu-west-1.rds.amazonaws.com','depbeuw9bkz','Gpqq1D7sLGp','depbeuw9bkz');
...
//	$db2=new mysqli('sup-psilva','records_officer','123456','user_management');
	...
	$db2=new mysqli('mysqlsdb.co8hm2var4k9.eu-west-1.rds.amazonaws.com','depbeuw9bkz','Gpqq1D7sLGp','depbeuw9bkz');
