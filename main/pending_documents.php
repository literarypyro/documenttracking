...
<tr>
<td>
<h2 class=""><a data-toggle="collapse" data-parent="#accordion" href="#collapsePending">Documents Needing Reply <?php echo "(".$nm.")"; ?></a></h2></th>
...
<td><?php echo $documentRow['subject']; ?> </td>
...
<?php
	...
	$routing_Option.="<option value='".$reference_number."'>".$documentRow['subject']."</option>";
	}
...
<tr>
<td>
<h2 class=""><a data-toggle="collapse" data-parent="#accordion" href="#collapsePending">Documents Needing Reply</a></h2></th>
...
<tr>
<td>
<h2 class=""><a data-toggle="collapse" data-parent="#accordion" href="#collapseSent">Documents Recently Sent <?php echo "(".$nm.")"; ?></a></h2></th>
