...
<tr>
<td>
<h2 class=""><a data-toggle="collapse" data-parent="#accordion" href="#collapseActiveDocs">Most Active Documents <?php echo "(".$nm.")"; ?></a></h2></th>
...
<tr>
<td>
<h2 class=""><a data-toggle="collapse" data-parent="#accordion" href="#collapseRecent">Most Recent Documents <?php echo "(".$nm.")"; ?></a></h2></th>
...
?>
	...
	<thead>
	<tr>
	<th colspan=8><h2>Active Documents for <?php echo $department; ?></h2></th>
	</tr>
	<tr>
	<th>Office Code</th>
	<th>Document Date</th>
